...
const en = {
  ...
  sub: "Master 1 AI student at Université Côte d'Azur. Six shipped projects. Looking for an apprenticeship.",
  cta: "See the projects",
  now_label: "CURRENTLY",
  peek: "a little peek at the work ↓",
  slot_meta: "NEXT PROJECT SLOT",
  slot_title: "Your next project",
  slot_desc: "Same card, new colour from the palette. The grid stays whole as the list grows.",
...
const fr: Dictionary = {
  ...
  sub: "Étudiant en Master 1 IA à l'Université Côte d'Azur. Six projets livrés. Je cherche une alternance.",
  cta: "Voir les projets",
  now_label: "EN CE MOMENT",
  peek: "un aperçu du travail ↓",
  slot_meta: "PROCHAIN PROJET",
  slot_title: "Le prochain projet",
  slot_desc: "Même carte, nouvelle couleur de la palette. La grille reste homogène quand la liste grandit.",
  certs: "CERTIFICATIONS",
  certs_btn: "Certifs",
  close: "Fermer",
